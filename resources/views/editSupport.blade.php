...
<section class="content">
    <form class="form-horizontal" id="support-form-edit" style="overflow-y: auto; overflow-x:hidden; height: 500px"
          enctype="multipart/form-data">
        <div class="parent-box">
            <?php $organizing = $model->support_unit->all(); ?>
            @if($organizing)
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-10">
                <button type="button" class="btn btn-default submit-support"
                        data-url="{{ route("milestone.editSupport",['id'=>$id]) }}">保存
                </button>
            </div>
        </div>
    </form>
